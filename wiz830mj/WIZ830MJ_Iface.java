...
public class WIZ830MJ_Iface extends HDLModule{
	...
	public WIZ830MJ_Iface(String... args) {
		...
		// for WIZ830MJ
		newPort("ADDR",   DIR.OUT,   HDLPrimitiveType.genVectorType(10), EnumSet.of(HDLPort.OPTION.EXPORT));
		newPort("DATA",   DIR.INOUT, HDLPrimitiveType.genVectorType(8),  EnumSet.of(HDLPort.OPTION.EXPORT));
		newPort("nCS",    DIR.OUT,   HDLPrimitiveType.genBitType(), EnumSet.of(HDLPort.OPTION.EXPORT));
		newPort("nRD",    DIR.OUT,   HDLPrimitiveType.genBitType(), EnumSet.of(HDLPort.OPTION.EXPORT));
